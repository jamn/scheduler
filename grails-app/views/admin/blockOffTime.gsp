...
<head></head><body>
	<div class="col-xs-12 col-sm-offset-1 col-sm-10 block-off-time">
		...
		<br />
		<input class="form-control" id="chooseDateToBlockOff" name="chooseDateToBlockOff" type="text" class="date">
		<br />
		<br />
		...
		:
		<select class="form-control" id="fromMinute">
			<option value="00">00</option>
			<option value="15">15</option>
			<option value="30">30</option>
			<option value="45">45</option>
		</select>
		<select class="form-control" id="fromMorningOrAfternoon">
		...
		:
		<select class="form-control" id="toMinute">
			<option value="00">00</option>
			<option value="15">15</option>
			<option value="30">30</option>
			<option value="45">45</option>
		</select>
		<select class="form-control" id="toMorningOrAfternoon">
			<option value="am">AM</option>
			<option value="pm">PM</option>
		</select>
		<br />
