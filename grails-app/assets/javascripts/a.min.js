...
}});}}function toggleAvailabilityForDay(b){console.log(b);var c=$("#available-"+b).is(":checked");var a=$(".day-"+b).find(".glyphicon");var d=$(".day-"+b).find("select");
if(c){$(".day-"+b).removeClass("unavailable");$(".day-"+b).addClass("available");a.removeClass("glyphicon-ban-circle");a.addClass("glyphicon-ok-circle");
d.prop("disabled",false);}else{$(".day-"+b).removeClass("available");$(".day-"+b).addClass("unavailable");a.removeClass("glyphicon-ok-circle");a.addClass("glyphicon-ban-circle");
d.prop("disabled",true);}}$(document).on("click",".availability .day-of-week",function(a){if(a.target.type!=="checkbox"){$(this).find("input:checkbox").trigger("click");
}});$(document).on("click",".availability .glyphicon",function(a){if(a.target.type!=="checkbox"){$(this).closest(".day").find("input:checkbox").trigger("click");
...
},400);setTimeout(function(){window.location.reload();},1250);}else{$("#rescheduleButton-"+a).html("Error");$("#rescheduleButton-"+a).addClass("error-button");
}});}