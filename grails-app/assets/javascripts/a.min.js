...
});$("#dateOfRescheduledAppointment-"+a).on("change",function(){getTimeSlotOptionsForRescheduledAppointment(a);});$("#rescheduleButton-"+a).on("click",function(){var d=$("#servicesForRescheduledAppointment-"+a).val();
