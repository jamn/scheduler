$(document).ready(function(){getSection("calendar");});function getTimeSlotOptions(){var a=$("#services").val();var b=$("#dateOfAppointment").val();if(a!="Choose a service..."){$.ajax({type:"POST",url:"/admin/getTimeSlotOptions",data:{sId:a,aDate:b}}).done(function(c){if(c.indexOf("ERROR")>-1){$("#bookForClientButton").html("Error");
