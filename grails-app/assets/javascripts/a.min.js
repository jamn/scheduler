...
}else{$("#timeSlotsForRescheduledAppointment-"+b).html(d);}});}}$(document).on("click","#addClient",function(a){$.ajax({type:"POST",url:"/admin/getClientDataForm"}).done(function(b){if(b.indexOf("ERROR")>-1){alert("Dang... you broke it.");
