...
}});}}function toggleAvailabilityForDay(a){var d=$("#"+a+"-available").is(":checked");var c=$(".day-"+a).find(".glyphicon");var b=$(".day-"+a).find("#"+a+"-open-timeslots");
var e=$(".day-"+a).find("#"+a+"-close-timeslots");if(d){$(".day-"+a).removeClass("unavailable");$(".day-"+a).addClass("available");c.removeClass("glyphicon-ban-circle");
c.addClass("glyphicon-ok-circle");b.prop("disabled",false);e.prop("disabled",false);}else{$(".day-"+a).removeClass("available");$(".day-"+a).addClass("unavailable");
c.removeClass("glyphicon-ok-circle");c.addClass("glyphicon-ban-circle");b.prop("disabled",true);e.prop("disabled",true);}}$(document).on("click",".availability .day-of-week",function(a){if(a.target.type!=="checkbox"){$(this).find("input:checkbox").trigger("click");
