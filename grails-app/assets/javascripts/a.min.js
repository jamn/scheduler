...
}else{$("#timeSlotsForRescheduledAppointment-"+b).html(d);}});}}function getSection(b){$("#mask").fadeIn();var a=$(".calendarStartDate").val();console.log(a);
$.ajax({type:"POST",url:"/admin/getSection",data:{section:b,calendarStartDate:"calendarStartDate"}}).done(function(c){$(".active").removeClass("active");
