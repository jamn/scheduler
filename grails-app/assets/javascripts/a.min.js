...
}else{getSection(a);$(".navbar-toggle").click();}});function getSection(a){$("#mask").fadeIn();$.ajax({type:"POST",url:"/admin/getSection",data:{section:a}}).done(function(b){$(".active").removeClass("active");
$('a[href="#'+a+'"]').parent().addClass("active");$(".main").html(b);$("#mask").fadeOut();});}$(document).on("tap","#addClient",function(a){$.ajax({type:"POST",url:"/admin/getClientDataForm"}).done(function(b){if(b.indexOf("ERROR")>-1){alert("Dang... you broke it.");
