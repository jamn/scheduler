...
}});}}function toggleAvailabilityForDay(a){var d=$("#"+a+"-available").is(":checked");var c=$(".day-"+a).find(".glyphicon");var b=$(".day-"+a).find("#"+a+"-open");
var e=$(".day-"+a).find("#"+a+"-close");if(d){$(".day-"+a).removeClass("unavailable");$(".day-"+a).addClass("available");c.removeClass("glyphicon-ban-circle");
