...
},1250);}else{$("#rescheduleButton-"+a).html("Error");$("#rescheduleButton-"+a).addClass("error-button");}});}$("#cancelAppointmentModal").on("show.bs.modal",function(c){var a=$(c.relatedTarget);
var b=$(this);b.find(".cancel-this-appointment").click(function(){});});