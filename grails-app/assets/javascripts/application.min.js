...
});}}function disableButton(a){$(a).attr("disabled","disabled");$(a).find(".as-button-label").hide();$(a).find(".spinner").show();}function getPageContent(b,e,a){var c=$(b).closest(".page").attr("page");
if(typeof c!="undefined"&&typeof a!="undefined"){var d="get"+a.charAt(0).toUpperCase()+a.slice(1);$.ajax({type:"POST",url:"site/"+d,data:e}).done(function(f){loadPageContent(c,a,f);
