...
class SchedulerService {
	...
	*******************************************************************/
	...
	public void deleteStaleAppointments(){
		...
		def now = new Date()
		numberOfTimeSlotsFreed += Appointment.executeUpdate("update Appointment a set a.deleted = true, a.updatedBy = 0, a.dateLastUpdated = :now where a.booked = false and a.deleted = false and a.dateCreated < :fiveMinutesAgo", [now:now, fiveMinutesAgo:fiveMinutesAgo])	
